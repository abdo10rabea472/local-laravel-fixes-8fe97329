...
Route::middleware(['auth:admin', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/settings/languages/{language}/translations/export', [\App\Http\Controllers\Admin\LanguageController::class, 'exportTranslations'])->name('settings.languages.translations.export');
    Route::post('/settings/languages/{language}/translations/import', [\App\Http\Controllers\Admin\LanguageController::class, 'importTranslations'])->name('settings.languages.translations.import');
