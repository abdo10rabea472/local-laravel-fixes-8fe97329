...
<div class="p-6 space-y-6">
    <h1 class="text-2xl font-bold text-slate-800">{{ __('app.admin_reports_inventory_heading') }}</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="bg-white border rounded-2xl overflow-hidden">
            <div class="px-5 py-4 border-b flex items-center justify-between">
                <h3 class="font-bold text-slate-800"><i class="fa-solid fa-triangle-exclamation text-amber-500"></i> {{ __('app.admin_reports_inventory_section_low_stock') }}</h3>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y">
                    ...
                    @empty
                        <tr><td colspan="4" class="text-center py-8 text-slate-400">{{ __('app.admin_reports_inventory_no_low_stock') }}</td></tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <div class="bg-white border rounded-2xl overflow-hidden">
            <div class="px-5 py-4 border-b flex items-center justify-between">
                <h3 class="font-bold text-slate-800"><i class="fa-solid fa-circle-xmark text-rose-500"></i> {{ __('app.admin_reports_inventory_section_out_of_stock') }}</h3>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y">
                    ...
                    @empty
                        <tr><td colspan="3" class="text-center py-8 text-slate-400">{{ __('app.admin_reports_inventory_no_out_of_stock') }}</td></tr>
                    @endforelse
                </tbody>
            </table>
    ...
    <div class="bg-white border rounded-2xl p-6">
        <h3 class="font-bold text-slate-800 mb-4"><i class="fa-solid fa-fire text-orange-500"></i> {{ __('app.admin_reports_inventory_section_top_movers') }}</h3>
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y">
                ...
                @empty
                    <tr><td colspan="4" class="text-center py-8 text-slate-400">{{ __('app.admin_reports_inventory_no_movements') }}</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
