                        ...
                        <td class="p-4">
                            <div class="flex gap-3">
                                ...
                                <form method="POST" action="{{ route('admin.products.destroy', $product) }}" data-ajax-confirm="حذف المنتج؟" data-ajax-remove>
                                    @csrf @method('DELETE')
                                    <button type="submit" class="text-rose-500 hover:text-rose-600" title="حذف"><i class="fa-solid fa-trash"></i></button>
                                </form>
                            </div>
                        </td>
                    </tr>
                    @empty
                    <tr><td colspan="6" class="p-12 text-center text-gray-500 dark:text-gray-400">
