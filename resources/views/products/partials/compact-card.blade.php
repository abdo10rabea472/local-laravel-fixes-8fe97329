    ...
    <div class="p-2.5 flex flex-col flex-1">
        ...
        <div class="mt-2 pt-2 flex items-center justify-between gap-1 border-t border-slate-100">
            <div class="min-w-0">
                ...
                @endif
                <span class="text-sm font-black text-slate-900 leading-tight">{{ number_format($displayPrice, 0) }} <span class="text-[10px] font-bold text-slate-500">EGP</span></span>
            </div>
            @if($inStock)
            ...
            @else
                <span class="text-[9px] font-bold text-rose-500 bg-rose-50 px-1.5 py-1 rounded">Out</span>
            @endif
        </div>
    </div>
</article>
