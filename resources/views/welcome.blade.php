...
<section class="relative overflow-hidden bg-gradient-to-br from-indigo-700 via-violet-700 to-fuchsia-700 text-white">
    ...
    <div class="relative max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        <div>
...
<section class="bg-white border-b border-slate-100">
    <div class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-6 grid grid-cols-2 lg:grid-cols-4 gap-4">
        @php
            $features = [
    ...
    <div class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        <div class="relative rounded-3xl overflow-hidden bg-gradient-to-br from-slate-900 via-indigo-900 to-violet-900 text-white p-8 sm:p-12 grid grid-cols-1 md:grid-cols-2 gap-6 items-center shadow-2xl">
            ...
            <div class="relative hidden md:grid grid-cols-3 gap-3">
                @foreach(['fa-microscope','fa-flask','fa-dna','fa-stethoscope','fa-calculator','fa-screwdriver-wrench'] as $ic)
                <div class="aspect-square rounded-2xl bg-white/10 backdrop-blur border border-white/15 flex items-center justify-center text-2xl text-white/90">
                    <i class="fa-solid {{ $ic }}"></i>
                </div>
                @endforeach
            </div>
